...
const defaultHeartImages = Array.from({ length: 12 }, (_, i) => `images/img${i + 1}.jpg`);
...
const ringTexts = [
  'Chúc các bạn 20/10 vui vẻ 8386 vạn sự như ý , triệu sự như mơ tỷ triệu bất ngờ tràn ngập may mắn',
  "Hi vọng mọi điều tốt đẹp sẽ đến với cậu, mang theo niềm vui và hạnh phúc. Dù có gặp khó khăn thế nào, tớ mong cậu luôn mạnh mẽ và tìm thấy những điều ý nghĩa trong cuộc sống. Cậu xứng đáng với tất cả những gì tuyệt vời nhất.",
  "Chúc mấy bà học hành thuận lợi, thi đâu trúng đó, năm nào cũng đạt danh hiệu “bông hoa sáng nhất”",
...
function preloadGalaxyAudio() {
  ...
  galaxyAudio.volume = 0.5;

  // Preload không autoplay
  galaxyAudio.preload = "auto";
   // Lắng nghe khi nhạc sẵn sàng
  galaxyAudio.addEventListener('canplaythrough', () => {
    audioLoaded = true;
    console.log("✅ Nhạc đã load xong!");
  });
